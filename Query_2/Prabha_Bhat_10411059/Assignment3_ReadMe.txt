...
-------------------------------
Step 1: Copy the Report3Test.java file to your local system.
...
if you aere running it using command prompt compile the program using "javac Report3Test.java"
then run it using "java Report3Test"
 ...
 * Step 9: Finally iterate through the elements in an ArralList and print the entries as expected by left indenting the string values and right indenting the integer values and displaying the date in expected format.